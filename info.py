...
API_ID = int(environ.get('API_ID', '29269304'))
API_HASH = environ.get('API_HASH', '5096697a0950c3753bfce5cd51b74602')

# Bot Token, This Is Main Bot
BOT_TOKEN = environ.get('BOT_TOKEN', "")

# Admin Telegram Account Id For Withdraw Notification Or Anything Else
ADMIN = int(environ.get('ADMIN', '5256273647'))
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002944421295'))
...
STREAM_URL = environ.get("STREAM_URL", "mongodb+srv://raghavraghu2904:evq9estTs0bHTmU7@cluster0.j4kfqut.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
LINK_URL = environ.get("LINK_URL", "https://one8hub.blogspot.com/p/file.html")
